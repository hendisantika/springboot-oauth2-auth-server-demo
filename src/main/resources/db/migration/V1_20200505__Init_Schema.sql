...
--
-- Table structure for tableoauth_access_token`
--
...
--
-- Table structure for tableoauth_client_details`
--
...
--
-- Table structure for tableoauth_client_token`
--
...
--
-- Table structure for tableoauth_code`
--
...
--
-- Table structure for tableoauth_refresh_token`
--
...
--
-- Table structure for tableuser_authority`
--
...
(
    ...
    CONSTRAINT FK_USER_AUTHORITY_AUTHORITY_ID FOREIGN KEY
        (authority_id) REFERENCES authority (id),
